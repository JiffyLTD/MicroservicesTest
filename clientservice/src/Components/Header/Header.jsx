    ...
    <header className="p-3 mb-3" style={{background: '#010A19'}}>
        <div className="container">
            <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <a href="/main" className=" d-flex align-items-center col-md-5 mb-0 mb-md-0 text-light text-decoration-none">
                    ...
                    <h5 className="px-3">Центр продажи поддержанных автомобилей</h5>
                </a>

                <ul className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 fs-4">
                    <li><a href="/main" className="nav-link px-2 link-light">Главная</a></li>
                    <li><a href="/dealers" className="nav-link px-2 link-light">Дилеры</a></li>
                    <li><a href="/allCars" className="nav-link px-2 link-light">Все авто</a></li>
